use agant_study::{
    constants::llm::DEEPSEEK_V4_1_FLASH,
    init,
    llm::{semaphore::get_semaphore, stream_retry::chat_stream_with_retry},
};
    ...
    for prompt in prompts {
        ...
        set.spawn(
            async move {
                ...
                let output =
                    chat_stream_with_retry(DEEPSEEK_V4_1_FLASH, Some("你是一个全能助理"), prompt)
                        .await?;
                drop(permit);
